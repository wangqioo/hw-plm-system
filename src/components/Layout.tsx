...
import {
  ...
  ShieldCheck, BookOpen, Menu, X, ChevronDown, Bell, User,
  Cpu, ChevronRight
} from 'lucide-react';
...
export default function Layout() {
  ...
  return (
    <div className="flex h-screen bg-[#F8FAFC] font-sans">
      ...
      <aside
        className={clsx(
          'flex flex-col bg-[#1E293B] text-white transition-all duration-300 flex-shrink-0',
          ...
          <div className="px-3 py-3 border-t border-white/10">
            <div className="flex items-center gap-2">
              ...
              <div className="overflow-hidden">
                ...
                <span className={clsx('text-[10px] px-1.5 py-0.5 rounded font-medium', roleColors[currentUser.role])}>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="bg-white border-b border-gray-200 px-4 py-3 flex items-center gap-3 flex-shrink-0">
          ...
          <div className="ml-auto flex items-center gap-2">
            ...
            <div className="relative">
              ...
              {notifOpen && (
                <div className="absolute right-0 top-full mt-2 w-72 bg-white rounded-xl shadow-xl border border-gray-200 z-50 overflow-hidden">
                  ...
                  {[
                    { text: 'USB Type-C 16P 待审核', time: '10分钟前', dot: 'bg-orange-400' },
                    { text: '贴片电感质量降级申请', time: '2小时前', dot: 'bg-red-400' },
                    { text: 'PRJ-2026-003 BOM待确认', time: '昨天', dot: 'bg-blue-400' },
                  ].map((n, i) => (
            ...
            {/* User */}
            <button className="flex items-center gap-2 px-3 py-1.5 rounded-lg hover:bg-gray-100 cursor-pointer transition-colors">
